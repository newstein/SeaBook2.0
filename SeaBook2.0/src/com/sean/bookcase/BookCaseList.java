...
//			int layoutParamsY = (130*myMetrics.heightPixels/320);
        ...
        public  int getCountX() {
            final DisplayMetrics myMetrics = getResources().getDisplayMetrics();
          int layoutParamsX = 0;
          Log.v(TAG, "SEAN_LOG X=" + myMetrics.widthPixels );     
          ...
          if (myMetrics.widthPixels > 480&&myMetrics.widthPixels <1280) {
              
              layoutParamsX = 96;    
          }         
          if (myMetrics.widthPixels >=1280) {
        ...
        public int getCountY() {
            final DisplayMetrics myMetrics = getResources().getDisplayMetrics();
          int layoutParamsY = 0;
          Log.v(TAG, "SEAN_LOG Y=" + myMetrics.heightPixels );   

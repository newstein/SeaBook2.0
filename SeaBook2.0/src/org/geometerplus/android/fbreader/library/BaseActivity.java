...
import com.sean.bookcase.BookCaseList.AppsAdapter;
...
abstract class BaseActivity extends ListActivity {
	...
	private GridView myGridView_ext;	
	...
	protected ImageView getCoverView(View parent) {
		if (myCoverWidth == -1) {
			...
			myCoverHeight =parent.getMeasuredHeight(); //108; //parent.getMeasuredHeight();
			myCoverWidth = myCoverHeight * 15 / 32; //100*15/32;//myCoverHeight * 15 / 32;
